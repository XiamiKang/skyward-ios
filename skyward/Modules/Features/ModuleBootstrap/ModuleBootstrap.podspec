#
# Be sure to run `pod lib lint ModuleBootstrap.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'ModuleBootstrap'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ModuleBootstrap.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/赵波/ModuleBootstrap'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '赵波' => 'zbo900801@gmail.com' }
  s.source           = { :git => 'https://github.com/赵波/ModuleBootstrap.git', :tag => s.version.to_s }
