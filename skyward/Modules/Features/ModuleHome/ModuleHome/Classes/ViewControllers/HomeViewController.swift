...
public class HomeViewController: BaseViewController, MapViewDelegate, SOSButtonDelegate {
    ...
    public override func setupConstraints() {
        ...
        centerTitleLabel.snp.makeConstraints { make in
            make.height.equalTo(swAdaptedValue(25))
        ...
        tableView.snp.makeConstraints { make in
            make.top.equalTo(centerTitleLabel.snp.bottom).offset(swAdaptedValue(6))
            make.leading.trailing.equalToSuperview().inset(16)
...
extension HomeViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        SWRouter.handle(RouteTable.convPageUrl, parameters: ["id" : UserManager.shared.userId])
    }
}
