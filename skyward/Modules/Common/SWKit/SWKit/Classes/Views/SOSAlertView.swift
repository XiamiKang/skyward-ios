...
public class SOSAlertView: UIView {
    ...
    @objc private func cancelButtonTapped() {
        ...
        NotificationCenter.default.post(name: .offlineReportState, object: ReportType.closeSOS)
        hide()
    }
    ...
    @objc private func confirmButtonTapped() {
        ...
        NotificationCenter.default.post(name: .offlineReportState, object: ReportType.openSOS)
        hide()
    }
